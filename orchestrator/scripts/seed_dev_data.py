"""Seeds one Org + one stub Agent for local dev, matching whatever
scripts/bootstrap_mattermost.sh created (docs/10-build-plan.md Phase 0).
Idempotent -- safe to re-run.

Usage: .venv/bin/python scripts/seed_dev_data.py --team-id <mattermost_team_id> --bot-user-id <echo_bot_user_id>
"""
import argparse
import asyncio
import sys
...
async def main(team_id: str, bot_user_id: str) -> None:
...
if __name__ == "__main__":
    ...
    asyncio.run(main(args.team_id, args.bot_user_id))
