...
- **Claude Code/Codex Runner:** invokes the agentic loop (via the Claude Agent SDK) with the resolved MCP config; this is where the actual multi-step tool use happens.
